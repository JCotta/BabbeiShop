$(document).ready(function() {       
      ...
      function convert_currency(value,type){
          ...
          var cents = 0.0;
          var oldFormat = Currency.moneyFormats[''][ Currency.format] || '';
  ...
  function loadMoreProduct(paramLimit, paramTotal){
    ...
    jQuery(document).ajaxComplete(function( event, xhr, settings ) {      
      ...
      if(index == paramTotal){
        ...
        loadMoreHTML	=	loadMoreHTML + "<a href='javascript:void(0);'>Carregue mais</a>";
    ...
    $('div[data-range-price]').slider({
      ...
      change: function(event, ui) {
        ...
        if(! vHasProduct){ /* Nếu duyệt hết mảng sản phẩm mà không tìm được sản phẩm thoả mãn điều kiện */
          vHtml +='<div class="shopify-info no-products"><i class="flash fa fa-exclamation-triangle" aria-hidden="true"></i>Não há produtos que correspondam ao seu preço</div>';
        }          
